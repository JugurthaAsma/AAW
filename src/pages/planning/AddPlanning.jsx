    ...
    <RoleNeedComponent neededRole="admin">
      ...
      <div className="d-flex mt-5 row">
        <div className="col-md-5">
          <Input value={name} placeholder="Planning's name" onChange={(e) => setName(e.target.value)} autoFocus />
        </div>
        <div className="col-md-5">
          <Input value={date} type="date" placeholder="Planning's date" onChange={(e) => setDate(e.target.value)} />
        </div>
