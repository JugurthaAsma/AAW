...
import adminaccount from "../img/adminaccount.png";
  ...
  <div className="box">
    <div className="box-content">
      ...
      <div className="description">Mode visiteur (donc sans compte) </div>
        ...
        <img  className="imagesHome" src={visitor} alt="visitor" /> 
        ...
        <p> Ici, on vous indique les différents accès qu'un utilisateur lambda a, après avoir créé un compte au préalable.
          ...
          vous avez juste à saisir votre nom et prénom, identique à celui saisie lors de l'inscription.
        </p>
        <p> Comptes existants: First name: Jugurtha, Last name: Asma  ou First name: Hylia, Last name: Boudahba</p>
        ...
        <div className="box">
          <div className="box-content" id="minibox">
            ...
            <div className="info"> L'utilisateur peut regarder la liste des plannings. Il peut consulter les manche correspondantes au planning concerné et décidé de s'y inscrire
            ou non via le bouton "join".
              <p className="success"> Lorque vous rejoignez une nouvelle manche, un message flash de succès va apparaitre.</p>
              <img  className="imagesHome" src={successmsg} alt="successmsg" /> 
            </div>
          </div>
        </div>
        ...
        <div className="box">
          <div className="box-content" id="minibox">
            ...
            <div className="info"> On peut consulter l'ensemble des manches existantes et décider de rejoindre une manche par exemple rejoindre la manche BMW correspondant au planning new Car.
              ...
              <img  className="imagesHome" src={errormessage} alt="errormessage" /> 
            </div>
          </div>
        </div>
        ...
        <div className="box">
          <div className="box-content" id="minibox">
            ...
            <div> En mode lecture seul, on peut voir l'ensemble des personnes inscrites et pour quel planning.
            ...
            <img  className="imagesHome" src={filter} alt="filter" /> 
          </div>
        </div>
        ...
        <img  className="imagesHome" src={adminaccount} alt="adminaccount" /> 
